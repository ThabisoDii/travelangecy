...
export const getUserApprovedTickets = async(req:Request,res:Response): Promise<Response> => {
  ...
  if(typeof bearerHeader !== 'undefined') {
    ...
    try{
     ...
     // var tokenVerification  = jwt.verify(bearerToken,'shhhhh')
      ...
      var response = await bookService.getUserApprovedTickets(decoded.userDetails);
